...
alter table did_entity add column created_by varchar(255);
alter table did_entity add column created_at timestamp;
alter table did_entity add column last_modified_by varchar(255);
alter table did_entity add column last_modified_at timestamp;

update did_entity set
                      created_at = CURRENT_TIMESTAMP,
                      last_modified_at = CURRENT_TIMESTAMP,
                      created_by = 'system',
                      last_modified_by = 'system';

alter table did_entity alter column created_at set not null;
alter table did_entity alter column last_modified_at set not null;
alter table did_entity alter column created_by set not null;
alter table did_entity alter column last_modified_by set not null;
